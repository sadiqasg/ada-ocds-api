...
exports.fetchHomepageStats = void 0;
const db_1 = __importDefault(require("../config/db"));
const fetchHomepageStats = (success) => {
   ...
   SELECT COUNT(budget_amount) as budget_amount FROM planning WHERE budget_amount = '0.00';
    ...
    `;
    db_1.default.query(queryString, (err, results, field) => {
        if (!err) {
            const response = {
                missing_data: {
...
exports.fetchHomepageStats = fetchHomepageStats;
